define({ "api": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "excludingTags",
            "description": "<p>exclude transaction lines with these tags</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    ...
    "groupTitle": "Ledger",
    "name": "GetGlLedger_idTransactions",
    "success": {
      "fields": {
        "Success 200": [
          {
  ...
  {
    "type": "get",
    "url": "/gl/:LEDGER_ID/snapshot/balances",
    "title": "balances",
    "group": "Ledger_Snapshot",
    "version": "v1.0.10",
    "description": "<p>Get a list of all balances in the ledger at a given date. Excludes back-dated transactions inserted after the date. Useful for reconciling balance differences in report for the same period but generated at different times.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
    ...
    "filename": "lib/routes/gl/snapshot/balances.js",
    "groupTitle": "Ledger_Snapshot",
    "name": "GetGlLedger_idSnapshotBalances",
    "success": {
      "fields": {
        "Success 200": [
          {
  ...
  },
  {
    ...
    "filename": "lib/routes/gl/snapshot/transactions.js",
    "groupTitle": "Ledger_Snapshot",
    "name": "GetGlLedger_idSnapshotTransactions"
  },
  {
    "type": "post",
    "url": "/gl/:LEDGER_ID/snapshot/create",
    "title": "create",
    "group": "Ledger_Snapshot",
    "version": "v1.0.10",
    "description": "<p>create a snapshot of the ledger at the given date (boosts the speed of snapshot fetching)</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "date",
            "description": "<p>The date for which the snapshot should be created.</p>"
          }
        ]
      }
    },
    "filename": "lib/routes/gl/snapshot/create.js",
    "groupTitle": "Ledger_Snapshot",
    "name": "PostGlLedger_idSnapshotCreate"
  },
  {
    "type": "get",
