...
Transaction.prototype = {
  ...
  forAccount: function (accountId, options) {
    ...
    var project = _.chain(lines).pluck('projectId').uniq().value().join(',');
   ...
   *     "lines": [
   *       { "account": "equipment", "amount": "2000.00", "counterpartyId": "apple", "projectId": "proj123" },
   *       { "account": "creditcard", "amount": "-2000.00", "counterpartyId": "apple" , "projectId": "proj123"}
   *     ]
   *   }
   *
   */
