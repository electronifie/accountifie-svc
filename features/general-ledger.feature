...
Feature: General Ledger
  ...
  Scenario: It provides an account history and trial balance for a period
    ...
    When I add the transactions:
      | id | date       | comment        | type    | lines.accountId | lines.amount | lines.counterpartyId | lines.projectId |
      |  1 | 2014-03-01 | 123: Cleaning  | expense |               1 |         1.00 | bedbath              |  proj123        |
      |    |            |                |         |               2 |        -1.00 | bedbath              |  proj123        |
      |    |            |                |         |                 |              |                      |                 |
      |  2 | 2014-04-01 | 124: Apple     | expense |               3 |         2.00 | apple                |  proj123        |
      |    |            |                |         |               4 |        -2.00 | apple                |  proj123        |
      |    |            |                |         |                 |              |                      |                 |
      |  3 | 2014-04-01 | 125: Pear      | expense |               1 |         3.00 | pear                 |  proj123        |
      |    |            |                |         |               2 |        -3.00 | pear                 |  proj123        |
      |    |            |                |         |                 |              |                      |                 |
      |  4 | 2014-04-02 | 126: Peach     | expense |               1 |         4.00 | peach                |  proj123        |
      |    |            |                |         |               4 |        -4.00 | peach                |  proj123        |
      |    |            |                |         |                 |              |                      |                 |
      |  5 | 2014-05-01 | 127: Apricot   | expense |               1 |         5.00 | apricot              |  proj123        |
      |    |            |                |         |               4 |        -5.00 | apricot              |  proj123        |

    And I save and restore from a snapshot

    Then the transaction history for account "1" from 2014-04-01 to 2014-04-30 should be:
      | id | date       | dateEnd | comment        | contraAccounts     | counterparty |  amount   | project |
      |  3 | 2014-04-01 |         | 125: Pear      | 2                  | pear         |      3.00 | proj123 |
      |  4 | 2014-04-02 |         | 126: Peach     | 4                  | peach        |      4.00 | proj123 |
  ...
  Scenario: It allows a transaction with multiple lines for the same account
    ...
    When I add the transactions:
      | id | date       | comment        | type    | lines.accountId | lines.amount | lines.counterpartyId | lines.projectId |
      |  1 | 2014-03-01 | 123: Cleaning  | expense |               1 |        10.00 | bedbath              |  proj123        |
      |    |            |                |         |               1 |        -3.00 | bedbath              |  proj123        |
      |    |            |                |         |               1 |        -6.00 | foobath              |  proj123        |
      |    |            |                |         |               2 |        -1.00 | foobath              |  proj123        |

    And I save and restore from a snapshot

    Then the transaction history for account "1" should be:
      | id | date       | dateEnd | comment        | contraAccounts | counterparty    |  amount   | project |
      |  1 | 2014-03-01 |         | 123: Cleaning  |              2 | bedbath,foobath |      1.00 | proj123 |
  ...
  Scenario: It allows transactions spanning multiple dates, and only includes the covered portion in the balance
    ...
    When I add the transactions:
      | id | date       | dateEnd    | comment              | type    | lines.accountId | lines.amount | lines.counterpartyId |  lines.projectId |
      |  1 | 2014-03-01 | 2014-05-31 | 123: Depreciation    | expense |               1 |        92.00 | depreci              |  proj123         |
      |    |            |            |                      |         |               2 |       -92.00 | depreci              |  proj123         |
      |    |            |            |                      |         |                 |              |                      |                  |
      |  2 | 2014-04-01 |            | 124: Apple           | expense |               3 |         2.00 | apple                |  proj123         |
      |    |            |            |                      |         |               4 |        -2.00 | apple                |  proj123         |
      |    |            |            |                      |         |                 |              |                      |                  |
    ...
    Then the transaction history for account "1" from 2014-04-01 to 2014-04-30 should be:
      | id | date       | dateEnd    | comment                      | contraAccounts     | counterparty |  amount   |  project |
      |  1 | 2014-04-01 | 2014-04-30 | 123: Depreciation (prorated) | 2                  | depreci      |     30.00 |  proj123 |
      |  3 | 2014-04-01 |            | 125: Pear                    | 2                  | pear         |      3.00 |  proj123 |
      |  4 | 2014-04-02 |            | 126: Peach                   | 4                  | peach        |      4.00 |  proj123 |
  ...
  Scenario: It keeps a balance history for accounts (for quick balance calculations)
    ...
    When I add the transactions:
      | id | date       | comment | type    | lines.accountId | lines.amount | lines.counterpartyId |  lines.projectId |
      |  1 | 2014-01-04 |       - | expense |               1 |         1.00 | bedbath              |  proj123         |
      |    |            |         |         |               2 |        -1.00 | bedbath              |  proj123         |
      |    |            |         |         |                 |              |                      |                  |
      |  2 | 2014-01-10 |       - | expense |               1 |         1.00 | bedbath              |  proj123         |
      |    |            |         |         |               2 |        -1.00 | bedbath              |  proj123         |
      |    |            |         |         |                 |              |                      |                  |
      |  3 | 2014-07-07 |       - | expense |               1 |         2.00 | bedbath              |  proj123         |
      |    |            |         |         |               2 |        -2.00 | bedbath              |  proj123         |
      |    |            |         |         |                 |              |                      |                  |
      |  4 | 2016-01-03 |       - | expense |               1 |        -1.00 | bedbath              |  proj123         |
      |    |            |         |         |               2 |         1.00 | bedbath              |  proj123         |
      |    |            |         |         |                 |              |                      |                  |
      |  5 | 2017-01-03 |       - | expense |               1 |        -1.00 | bedbath              |  proj123         |
      |    |            |         |         |               2 |         1.00 | bedbath              |  proj123         |
      |    |            |         |         |                 |              |                      |                  |
    ...
    When I add the transactions:
      | id | date       | comment | type    | lines.accountId | lines.amount | lines.counterpartyId | lines.projectId |
      |  4 | 2015-01-04 |       - | expense |               1 |         5.00 | bedbath              |  proj123        |
      |    |            |         |         |               2 |        -5.00 | bedbath              |  proj123        |
  ...
  Scenario: It allows transactions to be updated
    ...
    And I update the transactions:
      | id | date       | dateEnd    | comment              | type    | lines.accountId | lines.amount | lines.counterpartyId | lines.projectId |
      |  1 | 2014-03-01 | 2014-06-05 | 123: Depreciation    | expense |               1 |       194.00 | depreci              |  proj123        |
      |    |            |            |                      |         |               2 |      -194.00 | depreci              |  proj123        |
      |    |            |            |                      |         |                 |              |                      |                 |
      |  3 | 2014-04-03 |            | 125: Pear2           | expense |               3 |         4.00 | pear                 |  proj123        |
      |    |            |            |                      |         |               2 |        -4.00 | pear                 |  proj123        |

    Then the transaction history for account "1" from 2014-04-01 to 2014-04-30 should be:
      | id | date       | dateEnd    | comment                      | contraAccounts     | counterparty |  amount   | project |
      |  1 | 2014-04-01 | 2014-04-30 | 123: Depreciation (prorated) | 2                  | depreci      |     60.00 | proj123 | 
      |  4 | 2014-04-02 |            | 126: Peach                   | 4                  | peach        |      4.00 | proj123 | 
  ...
  Scenario: It allows transactions to be deleted
    ...
    When I add the transactions:
      ...
      |    |            |            |                      |         |               2 |       -92.00 | depreci              |  proj123        |
      |    |            |            |                      |         |                 |              |                      |                 |
      |  2 | 2014-03-25 |            | 124: Apple           | expense |               1 |         2.00 | apple                |  proj123        |
      |    |            |            |                      |         |               2 |        -2.00 | apple                |  proj123        |
      |    |            |            |                      |         |                 |              |                      |                 |
      |  3 | 2014-04-01 |            | 125: Pear            | expense |               1 |         3.00 | pear                 |  proj123        |
      |    |            |            |                      |         |               2 |        -3.00 | pear                 |  proj123        |
      |    |            |            |                      |         |                 |              |                      |                 |
  ...
  Scenario: It calculates balances at period edges
    ...
    When I add the transactions:
      | id | date       | dateEnd    | comment              | type    | lines.accountId | lines.amount | lines.counterpartyId | lines.projectId |
      |  1 | 2014-01-04 |            | -                    | expense |               1 |         1.01 | apple                |   proj123       |
      |    |            |            |                      |         |               2 |        -1.01 | apple                |   proj123       |
      |    |            |            |                      |         |                 |              |                      |                 |
      |  2 | 2014-03-01 | 2014-05-31 | -                    | expense |               1 |        92.92 | depreci              |   proj123       |
      |    |            |            |                      |         |               2 |       -92.92 | depreci              |   proj123       |
      |    |            |            |                      |         |                 |              |                      |                 |
      |  3 | 2014-03-03 | 2014-03-31 | -                    | expense |               1 |        29.29 | depreci              |   proj123       |
      |    |            |            |                      |         |               2 |       -29.29 | depreci              |   proj123       |
      |    |            |            |                      |         |                 |              |                      |                 |
      |  7 | 2014-06-01 |            | -                    | expense |               1 |         1.01 | apple                |   proj123       |
      |    |            |            |                      |         |               2 |        -1.01 | apple                |   proj123       |
  ...
  Scenario: It remembers results of previous queries
    ...
    When I add the transactions:
      | id | date       | dateEnd    | comment              | type    | lines.accountId | lines.amount | lines.counterpartyId | lines.projectId |
      |  1 | 2014-01-01 |            | -                    | expense |               1 |         1.01 | apple                |  proj123        |
      |    |            |            |                      |         |               2 |        -1.01 | apple                |  proj123        |
    And I flush the low priority queue
  ...
  Scenario: It carries fractions of cents across snapshot periods
    ...
    When I add the transactions:
      | id | date       | dateEnd    | comment              | type    | lines.accountId | lines.amount | lines.counterpartyId | lines.projectId |
      |  1 | 2013-12-01 |            | -                    | expense |               1 |         0.01 | apple                |  proj123        |
      |    |            |            |                      |         |               2 |        -0.01 | apple                |  proj123        |
      |    |            |            |                      |         |                 |              |                      |                 |
      |  3 | 2013-12-01 |            | -                    | expense |               1 |        -0.01 | apple                |  proj123        |
      |    |            |            |                      |         |               2 |         0.01 | apple                |  proj123        |
      |    |            |            |                      |         |                 |              |                      |                 |
      |  2 | 2014-01-01 | 2014-12-31 | -                    | expense |               1 |       365.02 | depreci              |  proj123        |
      |    |            |            |                      |         |               2 |      -365.02 | depreci              |  proj123        |
      |    |            |            |                      |         |                 |              |                      |                 |
      |  3 | 2015-02-01 |            | -                    | expense |               1 |         0.01 | apple                |  proj123        |
      |    |            |            |                      |         |               2 |        -0.01 | apple                |  proj123        |
  ...
  Scenario: It chunks transactions at month edges
    ...
    When I add the transactions:
      | id | date       | dateEnd    | comment              | type    | lines.accountId | lines.amount | lines.counterpartyId | lines.projectId |
      |  1 | 2014-04-01 |            | A                    | expense |               1 |         1.01 | apple                |  proj123        |
      |    |            |            |                      |         |               2 |        -1.01 | apple                |  proj123        |
      |    |            |            |                      |         |                 |              |                      |                 |
      |  2 | 2014-03-04 | 2014-05-29 | B                    | expense |               1 |        87.87 | depreci              |  proj123        |
      |    |            |            |                      |         |               2 |       -87.87 | depreci              |  proj123        |
      |    |            |            |                      |         |                 |              |                      |                 |
      |  3 | 2014-03-03 | 2014-03-05 | C                    | expense |               1 |         2.02 | depreci              |  proj123        |
      |    |            |            |                      |         |               2 |        -2.02 | depreci              |  proj123        |
      |    |            |            |                      |         |                 |              |                      |                 |
      |  4 | 2014-01-01 | 2014-12-31 | D                    | expense |               1 |       365.00 | depreci              |  proj123        |
      |    |            |            |                      |         |               2 |      -365.00 | depreci              |  proj123        |
      |    |            |            |                      |         |                 |              |                      |                 |
      |  5 | 2014-04-01 | 2014-05-01 | E                    | expense |               1 |        31.00 | depreci              |  proj123        |
      |    |            |            |                      |         |               2 |       -31.00 | depreci              |  proj123        |
      |    |            |            |                      |         |                 |              |                      |                 |
      |  7 | 2014-08-01 |            | F                    | expense |               1 |         1.01 | apple                |  proj123        |
      |    |            |            |                      |         |               2 |        -1.01 | apple                |  proj123        |
    ...
    Then the transaction history for account "1" from 2014-03-01 to 2014-06-30 chunked at "end-of-month" should be:
      | id | date       | dateEnd    | comment           | contraAccounts     | counterparty |  amount   | project |
      |  1 | 2014-04-01 |            | A                 | 2                  | apple        |      1.01 | proj123 |
      |  2 | 2014-03-04 | 2014-03-31 | B (prorated)      | 2                  | depreci      |     28.28 | proj123 |
      |  2 | 2014-04-01 | 2014-04-30 | B (prorated)      | 2                  | depreci      |     30.30 | proj123 |
      |  2 | 2014-05-01 | 2014-05-29 | B (prorated)      | 2                  | depreci      |     29.29 | proj123 |
      |  3 | 2014-03-03 | 2014-03-05 | C                 | 2                  | depreci      |      2.02 | proj123 |
      |  4 | 2014-03-01 | 2014-03-31 | D (prorated)      | 2                  | depreci      |     31.00 | proj123 |
      |  4 | 2014-04-01 | 2014-04-30 | D (prorated)      | 2                  | depreci      |     30.00 | proj123 |
      |  4 | 2014-05-01 | 2014-05-31 | D (prorated)      | 2                  | depreci      |     31.00 | proj123 |
      |  4 | 2014-06-01 | 2014-06-30 | D (prorated)      | 2                  | depreci      |     30.00 | proj123 |
      |  5 | 2014-04-01 | 2014-04-30 | E (prorated)      | 2                  | depreci      |     30.00 | proj123 |
      |  5 | 2014-05-01 | 2014-05-01 | E (prorated)      | 2                  | depreci      |      1.00 | proj123 |
  ...
  Scenario: It can exclude intracompany expenses
    ...
    When I add the transactions:
      | id | date       | dateEnd    | comment              | type    | lines.accountId | lines.amount | lines.counterpartyId | lines.projectId |
      |  1 | 2014-02-01 |            | A                    | expense |               1 |         1.00 | depreci              | proj123         |
      |    |            |            |                      |         |               2 |        -1.00 | depreci              | proj123         |
      |    |            |            |                      |         |                 |              |                      |                 |
      |  2 | 2014-02-11 |            | B                    | expense |               1 |         2.00 | llc                  | proj123         |
      |    |            |            |                      |         |               2 |        -2.00 | llc                  | proj123         |
      |    |            |            |                      |         |                 |              |                      |                 |
      |  3 | 2014-04-01 |            | C                    | expense |               1 |         3.00 | pear                 | proj123         |
      |    |            |            |                      |         |               2 |        -3.00 | pear                 | proj123         |
      |    |            |            |                      |         |                 |              |                      |                 |
      |  4 | 2014-04-02 |            | D                    | expense |               1 |         4.00 | llc                  | proj123         |
      |    |            |            |                      |         |               2 |        -4.00 | llc                  | proj123         |
      |    |            |            |                      |         |                 |              |                      |                 |
      |  5 | 2014-05-01 |            | E                    | expense |               1 |         5.00 | apricot              | proj123         |
      |    |            |            |                      |         |               2 |        -5.00 | apricot              | proj123         |
      |    |            |            |                      |         |                 |              |                      |                 |
      |  6 | 2014-07-01 |            | F                    | expense |               1 |         6.00 | apricot              | proj123         |
      |    |            |            |                      |         |               2 |        -6.00 | apricot              | proj123         |
    ...
    Then the transaction history for account "1" from 2014-04-01 to 2014-04-30 should be:
      | id | date       | dateEnd    | comment                      | contraAccounts     | counterparty |  amount   | project |
      |  3 | 2014-04-01 |            | C                            | 2                  | pear         |      3.00 | proj123 |
      |  4 | 2014-04-02 |            | D                            | 2                  | llc          |      4.00 | proj123 |
  ...
  Scenario: It can exclude transactions with conta accounts
    ...
    When I add the transactions:
      | id | date       | dateEnd    | comment              | type    | lines.accountId | lines.amount | lines.counterpartyId | lines.projectId |
      |  7 | 2014-01-01 |            | Y                    | expense |               1 |         7.00 | depreci              | proj123         |
      |    |            |            |                      |         |               2 |        -7.00 | depreci              | proj123         |
      |    |            |            |                      |         |                 |              |                      |                 |
      |  8 | 2014-01-05 |            | Z                    | expense |               1 |         8.00 | depreci              | proj123         |
      |    |            |            |                      |         |               3 |        -8.00 | depreci              | proj123         |
      |    |            |            |                      |         |                 |              |                      |                 |
      |  1 | 2014-02-01 |            | A                    | expense |               1 |         1.00 | depreci              | proj123         |
      |    |            |            |                      |         |               4 |        -1.00 | depreci              | proj123         |
      |    |            |            |                      |         |                 |              |                      |                 |
      |  2 | 2014-02-11 |            | B                    | expense |               1 |         2.00 | llc                  | proj123         |
      |    |            |            |                      |         |               2 |        -2.00 | llc                  | proj123         |
      |    |            |            |                      |         |                 |              |                      |                 |
    ...
    Then the transaction history for account "1" from 2014-02-01 to 2014-04-30 should be:
      | id | date       | dateEnd    | comment                      | contraAccounts     | counterparty |  amount   | project |
      |  1 | 2014-02-01 |            | A                            | 4                  | depreci      |      1.00 | proj123 |
      |  2 | 2014-02-11 |            | B                            | 2                  | llc          |      2.00 | proj123 |
      |  3 | 2014-04-01 |            | C                            | 3                  | pear         |      3.00 | proj123 |
      |  4 | 2014-04-02 |            | D                            | 2                  | llc          |      4.00 | proj123 |
  ...
  Scenario: It can restrict to a set of counterparties
    ...
    When I add the transactions:
      | id | date       | dateEnd    | comment              | type    | lines.accountId | lines.amount | lines.counterpartyId | lines.projectId |
      |  1 | 2014-02-01 |            | A                    | expense |               1 |         1.00 | pear                 | proj123         |
      |    |            |            |                      |         |               2 |        -1.00 | depreci              | proj123         |
      |    |            |            |                      |         |                 |              |                      |                 |
      |  2 | 2014-02-11 |            | B                    | expense |               1 |         2.00 | llc                  | proj123         |
      |    |            |            |                      |         |               2 |        -2.00 | pear                 | proj123         |
      ...
      |    |            |            |                      |         |               2 |        -3.00 | pear                 | proj123         |
      |    |            |            |                      |         |                 |              |                      |                 |
      |  4 | 2014-04-02 |            | D                    | expense |               1 |         4.00 | pear                 | proj123         |
      |    |            |            |                      |         |               2 |        -4.00 | llc                  | proj123         |
      |    |            |            |                      |         |                 |              |                      |                 |
      |  5 | 2014-05-01 |            | E                    | expense |               1 |         5.00 | apricot              | proj123         |
      |    |            |            |                      |         |               2 |        -5.00 | apricot              | proj123         |
      |    |            |            |                      |         |                 |              |                      |                 |
      |  6 | 2014-07-01 |            | F                    | expense |               1 |         6.00 | pear                 | proj123         |
      |    |            |            |                      |         |               2 |        -6.00 | apricot              | proj123         |
      |    |            |            |                      |         |                 |              |                      |                 |
      |  7 | 2014-09-01 |            | G                    | expense |               1 |         7.00 | apricot              | proj123         |
      |    |            |            |                      |         |               2 |        -7.00 | apricot              | proj123         |
    ...
    Then the transaction history for account "1" from 2014-02-02 to 2014-05-31 should be:
      ...
      |  2 | 2014-02-11 |            | B                            | 2                  | llc          |      2.00 | proj123 |
      |  3 | 2014-04-01 |            | C                            | 2                  | pear         |      3.00 | proj123 |
      |  4 | 2014-04-02 |            | D                            | 2                  | pear         |      4.00 | proj123 |
      |  5 | 2014-05-01 |            | E                            | 2                  | apricot      |      5.00 | proj123 |
  ...
  Scenario: It can restore from snapshots + events
    ...
    And I add the transactions:
      ...
      |    |            |                |         |                 |              |                      |                 |
      |  5 | 2014-05-01 | 127: Plum      | expense |               1 |         1.00 | plum                 |   proj123       |
      |    |            |                |         |               4 |        -1.00 | plum                 |   proj123       |
      |    |            |                |         |                 |              |                      |                 |
      |  6 | 2014-05-01 | 127: Apricot   | expense |               1 |         5.00 | apricot              |   proj123       |
      |    |            |                |         |               4 |        -5.00 | apricot              |   proj123       |
